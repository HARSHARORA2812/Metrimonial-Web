  ...
  { "id": 40, "name": "Oliver", "age": 27, "occupation": "AI Engineer", "interests": ["AI", "machine learning", "gaming"], "image": "https://randomuser.me/api/portraits/men/40.jpg", "education": "Master's in Artificial Intelligence", "location": "Boston", "height": "6'0\"", "religion": "Atheist" }
        ...
        if (profile) {
            profileDetails.innerHTML = `
                ...
                <h1>${profile.name}</h1>
                <p class="detail">Age: ${profile.age}</p>
                <p class="detail">Occupation: ${profile.occupation}</p>
                <p class="detail">Interests: ${profile.interests.join(", ")}</p>
                <p class="detail">Education: ${profile.education}</p>
                <p class="detail">Location: ${profile.location}</p>
                <p class="detail">Height: ${profile.height}</p>
                <p class="detail">Religion: ${profile. occupation}</p>
                <a href="index.html" class="back-button">Back to Matches</a>
                <div class="premium-section">
                    <p class="premium-message">**Upgrade to Premium to unlock more Chat Option!**</p>
                    <input type="text" class="contact-input" placeholder="Premium+ from more intactve tokens">
                    <button class="contact-button">Upgrade Now</button>
                </div>
            `;
        } else {
